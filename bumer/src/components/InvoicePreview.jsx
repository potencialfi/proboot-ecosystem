...
const InvoicePreview = ({ order, settings }) => {
    ...
    return (
        // ИСПРАВЛЕНИЕ: Убраны все flex и фиксированные высоты, добавлены стили для печати
        <div className="bg-white max-w-[210mm] mx-auto p-8 shadow-lg print:shadow-none print:max-w-none print:w-full print:p-8 print:m-0 overflow-hidden print:overflow-visible">
            ...
            {/* БЛОК ПІДСУМКІВ (Неразрывный блок) */}
